...
/**
 * A tool to create figures which implement the {@code TextHolderFigure} interface, such as {@code
 * TextFigure}. The figure to be created is specified by a prototype.
 *
